...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'password' => ['type' => 'string', 'length' => 512, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'UQ_email' => ['type' => 'unique', 'columns' => ['email'], 'length' => []],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-05-18 14:34:38',
                'deleted' => '2020-05-18 14:34:38',
            ],
        ];
        parent::init();
    }
